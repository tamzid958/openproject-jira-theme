  ...
  return (
    <div className="flex-1 grid place-items-center p-6">
      <div className="luxe-card max-w-md w-full p-8 text-center">
        ...
        <Link
          href="/projects"
          className="inline-flex items-center h-9 px-4 rounded-md bg-accent text-on-accent text-[13px] font-semibold transition-transform hover:-translate-y-px hover:bg-accent-600 shadow-(--card-highlight) no-underline"
        >
          Back to projects →
        </Link>
      </div>
